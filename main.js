...
function  style_1(){
    document.getElementById("selected_1").innerHTML="Selected"
    document.getElementById("selected_2").innerHTML=""
    document.getElementById("selected_3").innerHTML=""
}

function  style_2(){
    document.getElementById("selected_1").innerHTML=""
    document.getElementById("selected_2").innerHTML="Selected"
    document.getElementById("selected_3").innerHTML=""
}
...
function  style_3(){
    document.getElementById("selected_1").innerHTML=""
    document.getElementById("selected_2").innerHTML=""
    document.getElementById("selected_3").innerHTML="Selected"
